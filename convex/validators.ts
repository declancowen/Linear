...
export const workItemFields = {
  ...
  linkedWorkItemIds: v.optional(v.array(v.string())),
  referencedProjectIds: v.optional(v.array(v.string())),
  referencedViewIds: v.optional(v.array(v.string())),
  labelIds: v.array(v.string()),
...
export const commentFields = {
  ...
  referencedDocumentIds: v.optional(v.array(v.string())),
  referencedProjectIds: v.optional(v.array(v.string())),
  referencedViewIds: v.optional(v.array(v.string())),
...
export const chatReadStateFields = {
  ...
  messageReadAtById: v.optional(v.record(v.string(), v.string())),
  createdAt: v.string(),
  updatedAt: v.string(),
}
